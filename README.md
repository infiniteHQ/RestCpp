IMPORTANT : This repository is a fork of the simple rest client "restclient-cpp". This fork provides more behavior and adaptations for Vortex. Original Project : https://github.com/mrtazz/restclient-cpp
